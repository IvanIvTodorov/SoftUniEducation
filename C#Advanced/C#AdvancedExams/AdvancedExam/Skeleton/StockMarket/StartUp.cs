...
namespace StockMarket
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(investor.FindStock("Activision Blizzard"));
            // Print a stock200
            ...
            Console.WriteLine(investor.SellStock("Tesla", 150.00m));
            ...
            Console.WriteLine(investor.FindStock("Activisioon Blizzard"));
