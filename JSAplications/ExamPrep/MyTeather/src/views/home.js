...
<div id="events">
    ...
    <div class="theaters-container">
        ${obj.length == 0 ? html`<h4 class="no-event">No Events Yet...</h4>` : 
           obj.map(tamplateElement)
        }
    </div>
</div>
</section>
...
const tamplateElement = (obj) => html`
    <div class="eventsInfo">
            ...
            <div class="info">
                ...
                <h6 class="date">${obj.date}</h6>
                <h6 class="author">${obj.author}</h6>
                <div class="info-buttons">
                    <a class="btn-details" href="/details${obj._id}">Details</a>
                </div>
            </div>
        </div>
`;
